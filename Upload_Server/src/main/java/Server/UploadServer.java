...
//    private String Client_AD="192.168.0.1";//客户端IP地址
   ...
   // public UploadServer(){}
    ...
    public void creat_NetDisk(){
        File file=new File("C:\\Users\\20125\\Desktop\\GuaWazi-Network-Disk-master\\keep\\"+this.Client_ID+File.separator);
    ...
    public boolean Upload_Handler(String message)throws Exception{
        ...
        filebuff.put("Em",Em);
        File file=new File("C:\\Users\\20125\\Desktop\\GuaWazi-Network-Disk-master\\keep\\"+this.Client_ID+ File.separator+filename);
